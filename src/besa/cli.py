...
def _render_tree(
    ...
    class-name form, the default SPDX identifier for generated-file license headers, and the suffix
    ...
    for path in destination.rglob("*"):
        ...
        rendered = text.replace("vorlage", project_name).replace("Vorlage", project_class_name)
